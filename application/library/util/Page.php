...
class Util_Page{
    ...
    public $next_page  = '<i class="icon-angle-right"></i>';

    public $last_page  = '<i class="icon-double-angle-right"></i>';

    public $prev_page  = '<i class="icon-angle-left"></i>';

    public $first_page = '<i class="icon-double-angle-left"></i>';
    ...
    private function _buildOutput() {
        $this->_pagestring = '<ul class="' . $this->_pageclass . '">';
